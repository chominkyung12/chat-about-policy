...
client = openai.OpenAI(api_key="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")
...
# prompt's embedding과 파일들의 embedding간의 유사도를 얻기 위한 함수.
def cos_sim(A, B):
...
def create_prompt(df, query):
    ...
    and answering documents about Seoul's youth policy, developed by developers 조민경.
